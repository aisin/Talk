 ...
 * @Author      Aisin < wanghongchao@huxiu.com >
 * @Created     2015/5/15 16:15
 * @Version     1.0
 */
~function(win, doc) {
  ...
  Essage.prototype.show = function(message, duration) {
    ...
    duration && (timeout = function() {
      return setTimeout(function() {
        self.hide(self.config.callback, self.config.redirect);
      }, duration);
    });
  ...
  Essage.prototype.hide = function(callback, redirect) {
    ...
    interval = setInterval(function() {
      if(top === dest){
        redirect ? win.location.href = redirect : (typeof callback === 'function' ? callback.call(this) : void 0);
